...
6. **Add Keys**  
   ...
   - In the modal, choose the **lifetime** of all keys (1-90 days), and the **number of keys to generate.**
   - Click add.
...
8. **Configure Server & Script Settings**  
   - Scroll to **Server & Script Settings** at the bottom of the panel.  
     1. **HWID Reset Timeout (in hours)**  
        - Drag the slider to set how often users can reset their hwid.
     2. **Execution Log Webhook**  
        - Paste your Discord webhook URL to receive real-time notifications whenever the script executes.  
